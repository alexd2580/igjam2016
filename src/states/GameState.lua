...
function GameState:load()
    ...
    player = self:create_mothership(player, 100, 448/2, enemy, self.enabledItemsPlayer, nil)
    enemy = self:create_mothership(enemy, 512-100, 448/2, player, self.enemy_config.layers, self.enemy_config.mothership_ai)
