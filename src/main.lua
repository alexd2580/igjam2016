...
function love.load()
    ...
    resources:addImage('enemy40', 'assets/img/enemy/feindHealth40.png')
    resources:addImage('enemy20', 'assets/img/enemy/feindHealth20.png')
    resources:addImage('enemy00', 'assets/img/enemy/feindHealth00.png')
